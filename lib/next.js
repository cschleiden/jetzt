...
var NextPage = /** @class */ (function () {
    ...
    Object.defineProperty(NextPage.prototype, "isDynamicallyRouted", {
         ...
         */
        get: function () {
            return /\[(.+)\]\.js/.test(path_1.basename(this.path));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(NextPage.prototype, "route", {
        get: function () {
            ...
            return this.path
                .split(path_1.sep)
                .map(function (x) { return path_1.basename(x, ".js"); })
                .join("/");
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(NextPage.prototype, "pageName", {
         ...
         */
        get: function () {
            return path_1.basename(this.path, ".js");
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(NextPage.prototype, "targetPageName", {
        get: function () {
            return path_1.basename(this.targetPath, ".js");
        },
        enumerable: true,
        configurable: true
    });
    ...
    NextBuild.prototype.init = function (buildOutputPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sourcePath = path_1.join(this.path, ".next", "serverless");
                    ...
                    case 1:
                        ...
                        for (_i = 0, files_1 = files; _i < files_1.length; _i++) {
                            ...
                            this.pages.push(new NextPage(file, sourcePath, path_1.join(this.path, buildOutputPath)));
                        }
                        return [2 /*return*/];
                }
            });
