...
function createStorage(config) {
    return __awaiter(this, void 0, void 0, function () {
        var storageAccount, subscriptionId, location, resourceGroup, assetsContainerName, e_2, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 7:
                    e_3 = _a.sent();
                    exec_1.fail("Could not set storage container access level", e_3);
                    return [3 /*break*/, 8];
...
function createFunctionApp(config) {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionId, storageAccount, location, resourceGroup, name, ConfigName, e_4, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function upload(config) {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionId, resourceGroup, name, storageAccount, assetsContainerName, buildOutputPath, sourcePath, maxAttempts, attempt, e_6, e_7, e_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ...
                    log_1.log("Could not deploy package to Azure function app, waiting 5s and then retrying... " + e_6.message);
