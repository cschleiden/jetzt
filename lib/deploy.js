    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, step_1.runStep("Creating storage account...", function () { return createStorage(config); })];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, step_1.runStep("Creating function app...", function () { return createFunctionApp(config); })];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, step_1.runStep("Uploading package & assets...", function () { return upload(config); })];
                case 5:
                    _a.sent();
                    log_1.log("Successfully deployed to https://" + config.name + ".azurewebsites.net/");
                    return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent();
                    exec_1.fail("Could not find Azure CLI. Please install from https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest");
                    return [3 /*break*/, 3];
...
function createResourceGroup(config) {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionId, location, resourceGroup, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    e_1 = _a.sent();
                    exec_1.fail("Could not create resource group", e_1);
                    return [3 /*break*/, 4];
...
function createStorage(config) {
    return __awaiter(this, void 0, void 0, function () {
        var storageAccount, subscriptionId, location, resourceGroup, assetsContainerName, e_2, e_3, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    e_2 = _a.sent();
                    exec_1.fail("Could not create storage account", e_2);
                    return [3 /*break*/, 4];
                case 4:
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, exec_1.execAsync("az storage container create --subscription " + subscriptionId + " --name " + assetsContainerName + " --account-name " + storageAccount)];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 7:
                    e_3 = _a.sent();
                    exec_1.fail("Could not create storage container", e_3);
                    return [3 /*break*/, 8];
                case 8:
...
function upload(config) {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionId, resourceGroup, name, storageAccount, assetsContainerName, buildOutputPath, sourcePath, maxAttempts, attempt, e_7, e_8, staticPath, e_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    subscriptionId = config.subscriptionId, resourceGroup = config.resourceGroup, name = config.name, storageAccount = config.storageAccount, assetsContainerName = config.assetsContainerName, buildOutputPath = config.buildOutputPath, sourcePath = config.sourcePath;
                    maxAttempts = 3;
                    attempt = 1;
                    _a.label = 1;
                case 1:
                ...
                case 10:
                    ...
                    return [4 /*yield*/, exec_1.execAsync("az storage blob upload-batch --subscription " + subscriptionId + " --account-name " + storageAccount + " --destination " + assetsContainerName + " --destination-path _next --source " + path_1.join(buildOutputPath, "assets"))];
                case 11:
                    _a.sent();
                    return [3 /*break*/, 13];
                case 12:
                    ...
                    return [3 /*break*/, 13];
                case 13:
                    staticPath = path_1.join(sourcePath, "static");
                    if (!fs_1.existsSync(staticPath)) {
                        staticPath = path_1.join(sourcePath, "public");
                    }
                    if (!fs_1.existsSync(staticPath)) return [3 /*break*/, 17];
                    log_1.log("Uploading static assets to blob storage...", log_1.LogLevel.Verbose);
                    _a.label = 14;
                case 14:
                    _a.trys.push([14, 16, , 17]);
                    return [4 /*yield*/, exec_1.execAsync("az storage blob upload-batch --subscription " + subscriptionId + " --account-name " + storageAccount + " --destination " + assetsContainerName + " --destination-path static --source " + staticPath)];
                case 15:
                    _a.sent();
                    return [3 /*break*/, 17];
                case 16:
                    e_9 = _a.sent();
                    exec_1.fail("Could not upload assets to Azure blob storage", e_9);
                    return [3 /*break*/, 17];
