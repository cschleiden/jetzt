...
function upload(config) {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionId, resourceGroup, name, storageAccount, assetsContainerName, buildOutputPath, sourcePath, maxAttempts, attempt, e_7, e_8, e_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 14:
                    ...
                    return [4 /*yield*/, exec_1.execAsync("az storage blob upload-batch --subscription " + subscriptionId + " --account-name " + storageAccount + " --destination " + assetsContainerName + " --destination-path static --source " + path_1.join(sourcePath, "static"))];
                case 15:
                    _a.sent();
                    return [3 /*break*/, 17];
                case 16:
